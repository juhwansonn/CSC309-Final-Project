    ...
    <nav style={styles.nav}>
      <div style={styles.container}>
        ...
        <div style={styles.links}>
          ...
          <Link to="/promotions" style={styles.link}>
            Promotions
          </Link>
          ...
          {isCashierView && (
            <div style={styles.separator}>
              ...
              <Link to="/cashier" style={styles.link}>
                Charge
              </Link>
              <Link to="/redeem/process" style={styles.link}>
                Process
              </Link>
            </div>
          )}
          ...
          {isManagerView && (
            <div style={styles.separator}>
              ...
              <Link to="/manager/transactions" style={styles.link}>
                Global Tx
              </Link>
            </div>
          )}
