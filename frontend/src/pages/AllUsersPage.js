...
const AllUsersPage = () => {
  ...
  const handleSuspiciousToggle = async (userId, currentStatus) => {
    ...
    if (
      !window.confirm(`Mark this user as ${newStatus ? "SUSPICIOUS" : "Safe"}?`)
    )
      return;
          ...
          users.map((u) => (
            <li
              ...
              style={{
                ...
                backgroundColor: u.suspicious ? "#fff3f3" : "#fff",
              }}
            >
              <div>
                <div
                ...
                >
                  ...
                  {u.verified && (
                    <span title="Verified" style={{ cursor: "default" }}>
                      ✅
                    </span>
                  )}
                  {u.suspicious && (
              ...
              >
                <div style={{ display: "flex", gap: "5px" }}>
                  {!u.verified && (
                    <button
                      onClick={() => handleVerify(u.id || u._id)}
                      style={{
                        ...styles.actionBtn,
                  ...
                  <button
                    onClick={() =>
                      handleSuspiciousToggle(u.id || u._id, u.suspicious)
                    }
                    style={{
                      ...styles.actionBtn,
                      backgroundColor: u.suspicious ? "#6c757d" : "#dc3545",
                    }}
                  >
                ...
                <div style={{ display: "flex", gap: "5px" }}>
                  {u.role === "regular" && canPromote("cashier") && (
                    <button
                      onClick={() => handleRoleUpdate(u.id || u._id, "cashier")}
                  ...
                  {u.role !== "manager" && currentUser.role === "superuser" && (
                    <button
                      onClick={() => handleRoleUpdate(u.id || u._id, "manager")}
                      style={styles.actionBtn}
                    >
                      Make Manager
                    </button>
